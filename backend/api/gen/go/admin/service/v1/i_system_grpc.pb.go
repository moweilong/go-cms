...
const (
	SystemService_ListSystem_FullMethodName   = "/admin.service.v1.SystemService/ListSystem"
	SystemService_GetSystem_FullMethodName    = "/admin.service.v1.SystemService/GetSystem"
	SystemService_CreateSystem_FullMethodName = "/admin.service.v1.SystemService/CreateSystem"
	SystemService_UpdateSystem_FullMethodName = "/admin.service.v1.SystemService/UpdateSystem"
	SystemService_DeleteSystem_FullMethodName = "/admin.service.v1.SystemService/DeleteSystem"
)
...
func (c *systemServiceClient) ListSystem(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*ListSystemResponse, error) {
	...
	err := c.cc.Invoke(ctx, SystemService_ListSystem_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
