...
func (aq *AttachmentQuery) FirstIDX(ctx context.Context) uint32 {
...
func (aq *AttachmentQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (aq *AttachmentQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (aq *AttachmentQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AttachmentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(attachment.Table, attachment.Columns, sqlgraph.NewFieldSpec(attachment.FieldID, field.TypeUint32))
	_spec.From = aq.sql
