...
func (cq *CommentQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (cq *CommentQuery) FirstIDX(ctx context.Context) uint32 {
...
func (cq *CommentQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (cq *CommentQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (cq *CommentQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (cq *CommentQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
